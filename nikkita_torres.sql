...
INSERT INTO `__efmigrationshistory` VALUES ('20240225214956_Initial','6.0.0');
...
INSERT INTO `aspnetusers` VALUES ('36707305-71f7-4661-8079-8cb3ee19d7af','test@test.com','TEST@TEST.COM',NULL,NULL,0,'AQAAAAEAACcQAAAAEC3Qqnc1nEm2QZLzhXUgSa+Hy2hNDWRB/VMslR5mW1P1eE3krTELrDQxGcBbFw/XrA==','ECNGBMO4GKGTUD6GKO54URGYHQROOV5H','29658fd6-3726-477e-ab3c-1d4d222c3281',NULL,0,0,NULL,1,0);
...
INSERT INTO `flavors` VALUES (2,'Sweet','36707305-71f7-4661-8079-8cb3ee19d7af'),(3,'Salty','36707305-71f7-4661-8079-8cb3ee19d7af'),(4,'Spicy','36707305-71f7-4661-8079-8cb3ee19d7af');
...
INSERT INTO `flavortreats` VALUES (1,2,4);
...
CREATE TABLE `treats` (
  ...
  `UserId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`TreatId`),
  UNIQUE KEY `IX_Treats_FlavorId` (`FlavorId`),
  KEY `IX_Treats_UserId` (`UserId`),
  CONSTRAINT `FK_Treats_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`),
  CONSTRAINT `FK_Treats_Flavors_FlavorId` FOREIGN KEY (`FlavorId`) REFERENCES `flavors` (`FlavorId`) ON DELETE CASCADE
...
INSERT INTO `treats` VALUES (2,'Treat1',2,'36707305-71f7-4661-8079-8cb3ee19d7af'),(8,'Treat2',3,'36707305-71f7-4661-8079-8cb3ee19d7af');
...
-- Dump completed on 2024-02-25 15:01:10
